...
export const getLocationById = async (req: Request, res: Response) => {
    try {
        ...
        if (!destino) return res.status(404).json({ success: false, error: 'Destino no encontrado' });
...
export const deleteLocation = async (req: Request, res: Response) => {
    try {
        ...
        if (!deleted) return res.status(404).json({ success: false, error: 'Destino no encontrado' });
...
export const deleteLocationImage = async (req: Request, res: Response) => {
    try {
        ...
        if (!updated) return res.status(404).json({ success: false, error: 'Destino no encontrado' });
